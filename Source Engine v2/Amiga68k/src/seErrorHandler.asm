...
error049:    dc.b     "Error#49 : Illegal amount of parameters to cal BasicFOR Variable,StartValue, FinalValue (,optional Step).",10,0
error050:    dc.b     "Error#50 : The Basic For/Next requires integer variables or direct values as parameters.",10,0
error051:    dc.b     "Error#51 : The for/next buffer must be allocated only once.",10,0
error052:    dc.b     "Error#52 : Some buffers must be released before releasing For/Next buffer one.",10,0
error053:    dc.b     "Error#53 : Internal buffer for for/next datas is not created.",10,0
