...
gl\1labl:
    ...
    ELSEIF
      move.l      #0,gl\1(a3)                          ; Set the variable to equal 0 (not defined)
    ENDC
                    ENDM
...
glSte\1:
            ELSEIF
            move.L  #0,gl\1(a3)                        ; if NO STRING was defined, then we push pointer to be null (non defined String)
...
LoadGlobalVar   MACRO
    loadGlobalDatas a3
    move.l      gl\1(a3),\2                            ; Save the pointer of the static String in the variable datas
    move.w      gl\1+4(a3),\3                          ; Setup the global variable as a String variable with static content (dc.b)
                ENDM
