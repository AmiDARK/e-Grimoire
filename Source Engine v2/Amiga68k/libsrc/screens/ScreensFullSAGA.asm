...
oSA_BplLoop:
    ...
    logDebugMessage debugM12B,<"OpenScreen:1BitPlaneMemoryBlockAllocated">
    tst.l     d0
    beq       FailOpenScreenNotEnoughMemoryEx
...
err\1:
  ...
  addCustomError ScreenWidthMultipleOfSixteen,<"Error#SAGA06 : Screen width must be multiple of 16.">
