...
LibName:       dc.b 'cachectrl68020.library',0
idString:      dc.b 'cachectrl68020.library Ver1.0 '
               dc.b '68020 Version '
...
;----------- Routines personnelles
			Dc.l	Initialisation
			Dc.l	DataCacheMode	; Enable/Disable
			Dc.l	InstCacheMode	; Enable/Disable
			Dc.l	ClearDataCache	;
			Dc.l	ClearInstCache
...
; **************************************************************
DataBurstMode:
;					CPU 68020 HAS NO DATA BURST MODE
	Moveq.l	#0,d0
	Rts
; **************************************************************
InstBurstMode:
;					CPU 68020 HAS NO INST BURST MODE
	Moveq.l	#0,d0
	Rts
; **************************************************************
; **************************************************************
