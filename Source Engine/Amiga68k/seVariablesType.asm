...
bTypeStr           equ 2                       ; Bit 2 for Static String (dc.l)
bTypeNewStr        equ 3                       ; Bit 3 for String created with AllocMem (and that must be erased)
bTypeStakNewStr    equ 4                       ; Bit 4 Temporar New String (can be put to a variable without a real copy'n'paste)

; *****************************************************
; 2. Complexes variables types :
bTypeDim           equ 8                       ; Bit 8 for Dim (Integer, Float or String)
bTypeDynArr        equ 9                       ; Bit 9 for Dynamic Array (Integer, Float or String)
