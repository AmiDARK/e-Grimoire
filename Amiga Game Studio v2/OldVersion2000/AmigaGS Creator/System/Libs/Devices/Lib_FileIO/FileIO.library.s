...
LibName:       dc.b 'fileio.library',0
idString:      dc.b 'load and save files.library Ver1.0 '
               dc.b '680x0 Version '
...
_FileName:
	Dc.l	0
Adress:
	Dc.l	0	; Adresse ou le fichier sera chargé.
Length:
	Dc.l	0	; Longueur à charger demandé
StartFile:
	Dc.l	0	; 1er octet du fichier à lire.
FileHandle:
	dc.l	0
Dosrealread:
	Dc.l	0
...
; *********************************************************
; *                                                       *
; * CHARGER UN FICHIER à PARTIR D'UN DISQUE               *
; *                                                       *
; *********************************************************
; 			In	:	A0=FileName / A1=Adresse memoire / D0=longueur
LoadFile:
	Lea.l	Adress,a2
	Move.l	a1,(a2)
	Lea.l	Length,a2
...
;
; On essaye d'ouvrir le fichier si il existe.
	Lea.l	DosBase,a0
	Move.l	(a0),a6			; A6=Dos Base.
	Lea.l	_FileName,a1		; D1=File Name.
	Move.l	(a1),d1
...
; *********************************************************
; *                                                       *
; * ECRIRE UN FICHIER à PARTIR D'UNE ZONE MéMOIRE         *
; *                                                       *
; *********************************************************
; 			In	:	A0=FileName / A1=Adresse memoire / D0=longueur
SaveFile:
	...
	Lea.l	Length,a2
	move.l	d0,(a2)
; Mise en place du nom de fichier dans la librairie.
	Lea.l	_FileName,a1
_sii1b
	Move.b	(a0)+,(a1)+
	Tst.b	(a0)
...
; *********************************************************
; *                                                       *
; * CHARGER UN FICHIER CUSTOMIZé à PARTIR D'UN DISQUE     *
; *                                                       *
; *********************************************************
; 			In	:	A0=FileName / A1=Adresse memoire
;					D0=Longueur / D1=Start Read
LoadCustomFile:
	Lea.l	Adress,a2
	Move.l	a1,(a2)
	Lea.l	Length,a2
...
; On se positionne à l'endroit désiré pour lire le fichier.
	Move.l	d0,d1
	Lea.l	StartFile,a2
	Move.l	(a2),d2				; Position dans le fichier.
	Moveq.l	#0,d3				; Current position of file
	Jsr		DosSeek(a6)

;
; Lecture du fichier.
	Lea.l	FileHandle,a0
	Move.l	(a0),d1		; D1=FileHandle
	lea.l	Length,a0
	Move.l	(a0),d3		; D3=Length .
	Lea.l	Adress,a0
	Move.l	(a0),d2		; d2=Adress
