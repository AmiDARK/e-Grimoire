...
LibName:       dc.b 'chunky040.library',0
idString:      dc.b 'chunky040.library Ver1.0 '
               dc.b '68040+ Version '
			   dc.b '(24 Avril 00) ',13,10,0
...
Set_ChunkyBase:
	Lea.l	CHUNKY_BASE,a1
	Add.l	#4,a0
	Move.l	a0,(a1)
	Rts

Set_ScreenBase:
	Lea.l	SCREEN_BASE,a1
	Move.l	a0,(a1)
	Rts
...
Chunky:
	...
	Sub.l	#16,a0
	Lea.l	SCREEN_BASE,a1
	Move.l	(a1),a2			; On prend la screen base.
	Move.l	(a2),a1			; On envoie le premier bitplan.
	Tst.l	a1
	Beq.w	L6NoScreen
	Bra.b	_chunky2planar
L6NoChunky:
	Moveq	#0,d0
	Rts
L6NoScreen
