...
startHere:
    ...
    ; 10. Create the global to send to the procedure
    SetString Global2,<"Here is a global String to output to test global variables">
    logString Global2                 ; Log global string
